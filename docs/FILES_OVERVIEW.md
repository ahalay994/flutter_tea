...
**Основные функции:**
- `getTeas()` - получение списка всех чаёв с поддержкой мульти-тенантности (deviceId) через эндпоинт /device-tea
...
- `updateTea()` - обновление существующего чая с поддержкой мульти-тенантности (deviceId) через эндпоинт /device-tea
- `deleteTea()` - удаление чая с поддержкой мульти-тенантности (deviceId) через эндпоинт /device-tea
...
- `getTea()` - получение чая по ID с поддержкой мульти-тенантности (deviceId) через эндпоинт /device-tea
