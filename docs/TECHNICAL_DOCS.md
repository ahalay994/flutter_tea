...
- `getFilteredTeas()` (строки 75-111) - получение отфильтрованных чаёв с пагинацией (также может использоваться для получения всех чаёв с пагинацией без фильтров)
- `saveTea()` (строки 109-128) - сохранение чая
...
- `getFacets()` (строки 205-237) - получение фасетов
...
- `getFilteredTeas()` (строки 295-320) - получение отфильтрованных чаёв с пагинацией (также может использоваться для получения всех чаёв с пагинацией без фильтров)
